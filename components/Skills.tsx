...
const Skills = () => {
  ...
  return (
    <section id="skills" className="relative rounded-4xl mt-5 w-full min-h-screen py-10 px-40">
      <motion.div
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill, index) => (
                  ...
                  >
                    <div className="px-4 py-2 bg-gradient-to-r from-blue-500/10 to-blue-500/5 
